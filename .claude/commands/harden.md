...
2. Apply the insecure-defaults checklist from `skills/insecure-defaults/skills/insecure-defaults/SKILL.md`
3. Apply Python-specific checks from `skills/sharp-edges/skills/sharp-edges/references/lang-python.md`
