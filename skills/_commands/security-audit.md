Perform a comprehensive security audit of this codebase. Use the Trail of Bits security skills in `~/.claude/skills/` as reference methodology.

## Audit Scope
1. **Insecure Defaults** - Read `~/.claude/skills/insecure-defaults/skills/insecure-defaults/SKILL.md` and follow its workflow to find fail-open patterns, hardcoded secrets, weak defaults
2. **Sharp Edges** - Read `~/.claude/skills/sharp-edges/skills/sharp-edges/SKILL.md` and check for API footguns, dangerous configs, silent failures
