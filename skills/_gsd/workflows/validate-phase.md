...
```
Task(
  prompt="Read C:/Users/chris/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/chris/.claude/get-shit-done/templates/VALIDATION.md`
